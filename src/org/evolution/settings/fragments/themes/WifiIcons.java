...
public class WifiIcons extends InstrumentedFragment {

    private static final String TAG = "WifiIcons";
    private static final String ACTION_RELOAD_WIFI_ICONS = "com.android.systemui.RELOAD_WIFI_ICONS";
    private static final String WIFI_ICON_USE_OVERLAYS = "wifi_icon_use_overlays";
    ...
    private static void sendReloadBroadcast(Context context) {
        try {
            Intent intent = new Intent(ACTION_RELOAD_WIFI_ICONS);
    ...
    private static void updateOverlaySetting(Context context, boolean useOverlay) {
        try {
        ...
        public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(view -> {
                if (!pkg.equals(mSelectedPkg)) {
                    ...
                    boolean isDefault = "android".equals(pkg);
                    ...
                    Log.d(TAG, "Applied wifi icon overlay: " + pkg + 
                        ", use_overlays=" + !isDefault);
                }
            });
        }
